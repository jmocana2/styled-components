...
import DayMenu from './components/views/DayMenu';

const source = [
  {
    text: 'Ensaladas',
    id: 'Ensaladas',
    icon: 'icon-icon-salads',
    content: [
...
ReactDOM.render(
  <DayMenu
    ...
    source={source}
    title="MENÚ"
    subtitle="Objetivo bienestar cuida tu salud"
  />,
